    ...
    nav.innerHTML = `
      <div>
        ${navItems.map(([key, href, icon, label]) => {
          if (key === "FAB") {
            // Central floating Google button: perfect circle, purple, white G.
            // Breaks out above the bar; label aligns with the other tabs.
            return `<a class="nav-item nav-fab" href="google.html" aria-label="Google integration">
              ...
              <span class="nav-fab-label">Google</span>
            </a>`;
          }
